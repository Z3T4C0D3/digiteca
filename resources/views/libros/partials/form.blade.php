...
<div class="form-group @error('codigo')is-invalid @enderror">
...
<div class="form-group @error('Anio')is-invalid @enderror">
    {!! Form::label('Anio', 'Año de publicación del libro:') !!}
    {!! Form::text('Anio', null, 
    ['class' => 'form-control', 
...
<div class="form-group @error('idEditorial')is-invalid @enderror">
    {!! Form::label('idEditorial', 'Editorial de libro:') !!}
    {!! Form::select('idEditorial', $editoriales, null, 
  ...
  <div class="form-group">
    ...
    <select x-cloak id="select" name="autores[]" class="autores">
...
<div x-data="dropdown()" x-init="loadOptions()" class="w-full md:w-1/2 flex flex-col items-center h-64 mx-auto">
  <form>
      <input name="autores" type="hidden" x-bind:value="selectedValues()">
                  ...
                  <div class="my-2 p-1 flex border border-gray-200 bg-white rounded svelte-1l8159u">
                      <div class="flex flex-auto flex-wrap">
                          <template x-for="(option,index) in selected" :key="options[option].value">
                              <div
                                  class="flex justify-center items-center m-1 font-medium py-1 px-2 bg-white rounded-full text-dark-700 bg-teal-100 border border-teal-300 ">
                          ...
                          <div x-show="selected.length    == 0" class="flex-1">
                              <input placeholder="Seleccione un autor(es)"
...
<div class="row mb-3">
    ...
    <div class="col">
        ...
        @enderror
        <p>Seleccione una imagen acorde al libro que desea registrar</p>
    </div>
